...
class WeatherApp(QWidget):
    def __init__(self):
        ...
        self.city_entry.setFocus()
        self.setTabOrder(self.city_entry, self.units_combo)
        self.setTabOrder(self.units_combo, self.get_weather_button)
        self.setTabOrder(self.get_weather_button, self.refresh_button)
